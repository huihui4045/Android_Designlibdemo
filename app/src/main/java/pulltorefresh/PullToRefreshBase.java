...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout {
            ...
            case MotionEvent.ACTION_UP: {
                if (isBeingDragged) {
                    ...
                    if (state == RELEASE_TO_REFRESH && null != onRefreshListener) {
                        scrollTo(0, currentMode == MODE_PULL_DOWN_TO_REFRESH ? headerHeight
                                : headerHeight);
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        // Styleables from XML,设置刷新模式mode
        ...
        if (mode == MODE_PULL_DOWN_TO_REFRESH || mode == MODE_BOTH) {
            ...
            addView(headerLayout, new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
        ...
        if (a.hasValue(R.styleable.PullToRefresh_headerBackground_pull)) {
            this.setBackgroundResource(
                    a.getResourceId(R.styleable.PullToRefresh_headerBackground_pull, Color.WHITE));
            // this.setBackgroundResource(Color.WHITE);
        }
        if (a.hasValue(R.styleable.PullToRefresh_adapterViewBackground)) {
            refreshableView.setBackgroundResource(
                    a.getResourceId(R.styleable.PullToRefresh_adapterViewBackground, Color.WHITE));
